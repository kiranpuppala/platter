...
<div class="yourfriends"><b>People who liked this post</b></div>
...
$result=mysqli_query($dbc,$query) or die ('error for liker list');

while($row=mysqli_fetch_array($result)){

$likerid=$row['likerid'];

$query1="SELECT firstname,secondname,primage FROM candidates WHERE userid='$likerid'";
$result1=mysqli_query($dbc,$query1) or die('error details');
$row1=mysqli_fetch_array($result1);

echo '<div class="sender_title">';
echo '<img class="uploader_pic" src="images/'.$row1['primage'].'" alt="no image">';
echo '<p class="friend_name">'.$row1['firstname'].'&nbsp&nbsp'.$row1['secondname'].'<br>';
echo '<hr>';
}
...
background-color: #fff;color:#54696d;font-weight:bold;font-size:20px;
}
